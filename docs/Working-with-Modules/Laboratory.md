...
![alt text](<../../static/img/sample collection laboratory.PNG>)
...
![alt text](<../../static/img/sample testing and result.PNG>)
...
![alt text](<../../static/img/Sample tracking.PNG>)
...
![alt text](../../static/img/Report.PNG)
...
![alt text](../../static/img/Maintenance.PNG)
